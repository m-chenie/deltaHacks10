theme_prompts = {
    ...
    "retro": "Embrace a retro vibe in the video, featuring music and aesthetics from past decades like the groovy 70s or the vibrant 80s, perfect for nostalgic and upbeat themes.",
    "ambient": "Set a peaceful and ethereal tone with an ambient theme, using soft, flowing music that creates a calming and meditative atmosphere, ideal for serene landscapes and introspective moments."
}
